...
```bash
python baseline/baseline_part1.py extract_frames \
...
```bash
python baseline/baseline_part1.py make_lr \
...
```bash
python baseline/baseline_part1.py interpolate \
  --lr_dir data/lr_x4 \
...
```bash
python baseline/baseline_part1.py train_srcnn \
  --hr_dir data/hr_frames \
...
```bash
python baseline/baseline_part1.py infer_srcnn \
  --lr_dir data/lr_x4 \
...
```bash
python baseline/baseline_part1.py temporal_avg \
...
```bash
python baseline/baseline_part1.py evaluate \
...
```bash
python baseline/baseline_part1.py frames_to_video \
  --frames_dir outputs/srcnn_x4 \
  --out_video outputs/videos/srcnn_x4.mp4 \
  --fps 24
```
