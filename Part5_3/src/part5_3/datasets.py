"""Dataset and Part2-output discovery for Part 5.3."""
...
def part2_frames_dir(part2_root: str | Path, input_model: str, dataset: str, sequence_name: str) -> Path:
    return Path(part2_root) / input_model / dataset / sequence_name / "frames"


def part3_frames_dir(out_root: str | Path, run_name: str, input_model: str, dataset: str, sequence_name: str) -> Path:
    return Path(out_root) / run_name / input_model / dataset / sequence_name / "frames"


def part3_video_path(out_root: str | Path, run_name: str, input_model: str, dataset: str, sequence_name: str) -> Path:
...
def _discover_wild(
    ...
    if wild_frames:
        ...
        input_dir = part2_frames_dir(part2_root, input_model, "wild", frames_dir.name)
