"""Create qualitative comparison grids for Part 5.3."""
...
from .datasets import discover_sequences, part3_frames_dir
from .image_io import list_image_files, read_image


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create Part 5.3 visual comparison grids.")
...
def main() -> None:
    ...
    for item in sequences:
        ...
        for method in args.methods:
            pred_dir = part3_frames_dir(args.pred_root, method, args.input_model, args.dataset, item.name)
